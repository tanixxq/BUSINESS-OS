            ...
            <div className="flex h-[89%]">
                ...
                <aside className="w-[21%] border-r border-[#ddd8d0] bg-[#eeeae3] p-3">
                    ...
                    <div className="mt-8 pt-4 border-t border-[#d8d2c9]">
                        ...
                        <p className="px-3 text-[12px] uppercase tracking-wider text-[#99938b]">
                            Workspace
                        </p>

                        <button className="w-full text-left px-3 py-2 mt-2 rounded-md text-[10px] text-[#68645e] hover:bg-[#e3ded6]">
                            Settings
                        </button>
